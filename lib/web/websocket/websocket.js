...
class WebSocket extends EventTarget {
  ...
  #onConnectionEstablished (response, parsedExtensions) {
    ...
    // Get maxDecompressedMessageSize from dispatcher options
    const maxDecompressedMessageSize = this.#handler.controller.dispatcher?.webSocketOptions?.maxDecompressedMessageSize
